                    ...
                    <div class="scrollbar-sidebar scrollbar-container">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="<?php echo ($menu_principal == 'Dashboards')? 'mm-active' : '';?>" >
                                    <a href="#">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Dashboards
                                        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                    </a>
                                    <ul class="<?php echo ($menu_secundario == 'Home')? 'mm-show' : '';?>" >
                                        <li><a  class="<?php echo ($menu_secundario == 'Home')? 'mm-active' : '';?>" href="{{ url('/painel') }}">Home</a></li>
                                    </ul>
                                </li>
                                        ...
                                        <div class="widget-content-left">
                                            <div class="btn-group">
                                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                    <img width="42" class="rounded" src="{{ url('/ProAssets/images/avatars/padrao.png') }}" alt="">
                                                                    ...
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="widget-content-left mr-3">
                                                                            <img width="42" class="rounded-circle"
                                                                                 src="{{ url('/ProAssets/images/avatars/padrao.png') }}"
                                                                                 alt="">
                                                                        </div>
                                                                        <div class="widget-content-left">
                                                                        ...
                                                                        <div class="widget-content-right mr-2">
                                                                            <button onclick="location.href='{{ url('painel/logout') }}'" class="btn-pill btn-shadow btn-shine btn btn-focus">Sair
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script src="{{url('ProAssets/js/scripts-init/charts/chartjs.js')}}"></script>
...
<!--Form Validation-->
<script src="{{url('ProAssets/js/vendors/form-components/form-validation.js')}}"></script>
<script src="{{url('ProAssets/js/scripts-init/form-components/form-validation.js')}}"></script>

<!--Form Wizard-->
<script src="{{url('ProAssets/js/vendors/form-components/form-wizard.js')}}"></script>
<script src="{{url('ProAssets/js/scripts-init/form-components/form-wizard.js')}}"></script>
